...
点击基本信息并校验点击是否生效
    ...
    click element                       xpath=//*[@id="roottitle"]/div[1]         #点击列表重点基本信息
...
展开所有菜单
    ...
    wait until element is visible   xpath=//*[@class="l-btn-text icon-expand"]      30  展开按钮没有显示
    wait until element is enabled   xpath=//*[@class="l-btn-text icon-expand"]
    mouse over              xpath=//*[@class="l-btn-text icon-expand"]   #鼠标移动到展开上面
    ${count_open}  Get WebElements   //*[@class="menu-text"]           #获取2个下拉菜单
...
点击部门管理并且验证页面元素
    ...
    sleep  5
    element is visible and click  //*[text()='部门管理']      30      部门管理菜单没能及时刷新
